...
vgDi = [0.0665, 0.4193, 0.0051, 1.6727, 21.82]
...
if plotResults:
    ...
    res = pd.DataFrame({'time':timePlot, 'P3_E': results, 'P3_fw': resultsfw, 'P3_pl':resultspl, 'P3_An':resultsAn, 'P3_Vc':resultsVc,'P3_Vj':resultsVj, 'P3_gco2': resultsgco2}) 
