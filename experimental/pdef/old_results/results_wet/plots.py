...
# Plot An 
plt.figure()
plt.plot(P0_mean_values['time'].values, P0_mean_values['An'].values, label = 'P0')

plt.fill_between(P0_mean_values['time'].values, P0_mean_values['An'].values - P0_std_values['An'].values,
                     P0_mean_values['An'].values + P0_std_values['An'].values, alpha=0.3)

plt.plot(P1_mean_values['time'].values, P1_mean_values['An'].values,label = 'P1')

plt.fill_between(P1_mean_values['time'].values, P1_mean_values['An'].values - P1_std_values['An'].values,
                     P1_mean_values['An'].values + P1_std_values['An'].values, alpha=0.3)

plt.plot(P2_mean_values['time'].values, P2_mean_values['An'].values,label = 'P2')

plt.fill_between(P2_mean_values['time'].values, P2_mean_values['An'].values - P2_std_values['An'].values,
                     P2_mean_values['An'].values + P2_std_values['An'].values, alpha=0.3)

plt.plot(P3_mean_values['time'].values, P3_mean_values['An'].values,label = 'P3')

plt.fill_between(P3_mean_values['time'].values, P3_mean_values['An'].values - P3_std_values['An'].values,
                     P3_mean_values['An'].values + P3_std_values['An'].values, alpha=0.3)
