...
simDuration = 28
rinit = initPlant(simDuration, condition="dry")
r = rinit[0]
weatherX = rinit[1]
rinit = initPlant(simDuration, condition="dry")
...
resultsAnC3.to_csv(str(name)+"_resultsAnC3.csv", index=False)
resultsAnC4.to_csv(str(name)+"_resultsAnC4.csv", index=False)
resultsFwC4.to_csv(str(name)+"_resultsFwC4.csv", index=False)
